...
function setup() {
  ...
  kangaroo = createSprite(400,100,400,29);
  kangaroo.addAnimation("kangaroo",kangaroo_running);
  kangaroo.scale=0.3
  kangaroo.x = width / 300;
  shrubsGroup = new Group();
  obstaclesGroup = new Group();
  invisibleGround = createSprite(400,380,400,5);
